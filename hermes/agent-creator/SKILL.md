...
6. Verify the job exists in Hermes's all-profile cron roster before presenting it as created. Never add or preserve a Fluid card to simulate an agent that Hermes does not report.
